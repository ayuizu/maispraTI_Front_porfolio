...
function insert() {
    ...
    if(radio == "Ação") {
        let insert = window.document.getElementById("insertAcao");
        insert.innerHTML = `
            <th scope='row'>${cod}</th>
    ...
    if(radio == "Animação") {
        let insert = window.document.getElementById("insertAnim");
        insert.innerHTML = `
            <th scope='row'>${cod}</th>
            <td scope='col'>${title}</td>
            <td scope='col'>${director}</td>
    ...
    if(radio == "Romance") {
        let insert = window.document.getElementById("insertRoman");
        insert.innerHTML = `
            <th scope='row'>${cod}</th>
            <td scope='col'>${title}</td>
            <td scope='col'>${director}</td>
    ...
    if(radio == "Suspense") {
        let insert = window.document.getElementById("insertSus");
        insert.innerHTML = `
            <th scope='row'>${cod}</th>
            <td scope='col'>${title}</td>
            <td scope='col'>${director}</td>
